...
const tours: Tour[] = [
  {
    ...
    description:
      "Explore the iconic Pyramids of Giza and the majestic Sphinx. A journey back in time to the land of Pharaohs, this tour offers an unforgettable glimpse into ancient Egypt's most famous landmarks.",
    itinerary: [
      {
        day: 1,
        activity:
          "Arrival in Cairo, transfer to hotel, evening visit to Khan el-Khalili bazaar.",
      },
      {
        day: 2,
        activity:
          "Full day tour of the Giza Plateau: Great Pyramids, Sphinx, and Solar Boat Museum.",
      },
      {
        day: 3,
        activity:
          "Visit the Egyptian Museum to see the treasures of Tutankhamun, then departure.",
      },
    ],
    availability: true,
    images: [
    ...
    availabilityDescription:
      "Available daily. Book at least 48 hours in advance.",
    ...
    cancellationPolicy:
      "Cancel up to 7 days in advance for a full refund. No refunds for cancellations made within 7 days of the tour.",
  },
  {
    id: "2",
    ...
    description:
      "Discover the treasures of ancient Thebes. Visit the Valley of the Kings, Karnak Temple, and Luxor Temple in this comprehensive tour of the world's greatest open-air museum.",
    itinerary: [
      {
        day: 1,
        activity:
          "Arrival in Luxor, visit the grand Luxor Temple illuminated at night.",
      },
      {
        day: 2,
        activity:
          "Explore the West Bank: Valley of the Kings, Temple of Hatshepsut, and the Colossi of Memnon.",
      },
      {
        day: 3,
        activity: "Visit the vast Karnak Temple Complex and the Luxor Museum.",
      },
      {
        day: 4,
        activity:
          "Optional hot air balloon ride over the West Bank at sunrise, followed by departure.",
      },
    ],
    availability: true,
    images: [
    ...
    pickupAndDropoff:
      "Pickup from Luxor International Airport or any Luxor hotel.",
    highlights: [
    ...
    cancellationPolicy:
      "Full refund for cancellations made at least 14 days before the start date of the experience.",
  },
  {
    id: "3",
    ...
    description:
      "Sail the majestic Nile River from Aswan to Luxor. Enjoy stunning scenery, visit ancient temples, and relax on a luxury 5-star cruise ship. This is the classic Egyptian travel experience.",
    itinerary: [
      {
        day: 1,
        activity:
          "Embark in Aswan, visit the High Dam and the beautiful Philae Temple on Agilkia Island.",
      },
      {
        day: 2,
        activity:
          "Sail to Kom Ombo and visit the unique temple dedicated to two gods, Sobek and Haroeris.",
      },
      {
        day: 3,
        activity:
          "Sail to Edfu, visit the best-preserved cult temple in Egypt, the Temple of Horus.",
      },
      {
        day: 4,
        activity:
          "Sail to Luxor, visit the East Bank (Karnak & Luxor Temples).",
      },
      {
        day: 5,
        activity: "Disembark after breakfast. Optional tour to the West Bank.",
      },
    ],
    availability: true,
    images: [
    ...
    pickupAndDropoff:
      "Pickup from Aswan airport or hotels. Drop-off at Luxor airport or hotels.",
    highlights: [
    ...
    cancellationPolicy:
      "A 50% charge for cancellations within 15 days of departure. No refund for cancellations within 7 days.",
  },
  {
    id: "4",
    ...
    description:
      "Dive into the vibrant coral reefs of the Red Sea. A world-class diving experience for beginners and experts alike in the famous waters of Sharm El Sheikh.",
    itinerary: [
      {
        day: 1,
        activity: "Arrival in Sharm El Sheikh, check into your beach resort.",
      },
      {
        day: 2,
        activity:
          "Dive briefing and first two dives in the stunning Ras Mohammed National Park.",
      },
      {
        day: 3,
        activity: "Full day trip to dive the legendary SS Thistlegorm wreck.",
      },
      {
        day: 4,
        activity: "Day of relaxation or optional desert quad biking adventure.",
      },
      {
        day: 5,
        activity: "Two incredible dives at the reefs of Tiran Island.",
      },
      {
        day: 6,
        activity:
          "Free day for beach activities, shopping in Naama Bay, or relaxing by the pool.",
      },
    ...
    availabilityDescription:
      "Available year-round. PADI certification required for wreck dive.",
    ...
    cancellationPolicy:
      "Requires a 30-day cancellation notice for a full refund due to boat booking requirements.",
  },
  {
    id: "5",
    ...
    description:
      "Relax on the sunny beaches of Hurghada. Enjoy watersports, fresh seafood, and the vibrant resort atmosphere of this Red Sea paradise.",
    itinerary: [
      {
        day: 1,
        activity:
          "Arrival in Hurghada and transfer to your all-inclusive resort.",
      },
      {
        day: 2,
        activity: "Full day at leisure to enjoy the beach and hotel pools.",
      },
      {
        day: 3,
        activity: "Boat and snorkeling trip to the beautiful Giftun Island.",
      },
      {
        day: 4,
        activity: "Explore the modern Hurghada Marina and enjoy local cuisine.",
      },
      {
        day: 5,
        activity:
          "Free day for optional activities like glass-bottom boat or submarine tour.",
      },
    ...
    cancellationPolicy:
      "Full refund for cancellations up to 3 days before arrival.",
  },
  {
    id: "6",
    ...
    description:
      "Day tour to Alexandria 10 hours starts every day from 7 am to 18:00 pm. Explore the historic city of Alexandria. Visit the modern library, Roman amphitheater, and enjoy the Mediterranean sea breeze.",
    itinerary: [
      {
        day: 1,
        activity:
          "Pick up from your hotel in Cairo or Giza. Drive to Alexandria. Visit Pompey's Pillar, the Catacombs, the Library of Alexandria, and Qaitbay Citadel from the outside. Lunch at a local fish market restaurant. Return to Cairo in the evening.",
      },
    ],
    availability: false,
    images: [
    ...
    excludes: ["Personal items", "Tipping"],
    cancellationPolicy:
...
export const getTourById = (idOrSlug: string): Tour | undefined =>
  getTours().find((tour) => tour.id === idOrSlug || tour.slug === idOrSlug);
